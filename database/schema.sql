...
CREATE TABLE usuarios (
    ...
    admin_role       ENUM('super_admin', 'admin_faculdade', 'instrutor') NULL DEFAULT NULL,
...
CREATE TABLE convites_admin (
    ...
    admin_role       ENUM('super_admin', 'admin_faculdade', 'instrutor') NOT NULL DEFAULT 'instrutor',
