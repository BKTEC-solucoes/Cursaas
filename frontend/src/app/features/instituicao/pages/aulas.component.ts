              ...
              <div class="videos-section">
                ...
                @for (v of aulaDetalhe.videos ?? []; track v.id) {
                  <div class="video-item">
                    <div class="video-player-wrap"><video controls [src]="getVideoUrl(v.caminho_arquivo) | async" class="video-player" preload="metadata">Seu navegador não suporta reprodução de vídeo.</video></div>
