...
const icons = {
  ...
  tema:      `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.276-.31-.457-.702-.457-1.125a1.64 1.64 0 0 1 1.64-1.64h1.936c3.316 0 6.02-2.7 6.02-6.024C21.35 6.156 17.24 2 12 2z"/></svg>`,
          ...
          <div class="nav-group">
            ...
            @if (p.can('tema:read')) {
              <a routerLink="/admin/tema" routerLinkActive="active" [title]="isCollapsed() ? 'Tema' : ''">
                <span class="icon" [innerHTML]="icons.tema"></span>
